...
describe('Home Module', () => 
{
 ...
 {
   cy.visit('/')
   cy.get('[data-cy=country-ddl]').select('7: LU').wait(1000)
 ...
 */
 ...
 it('View links', () =>
 {
   cy.get('.start-link').eq(0).click({force:true})
     .should('have.attr','href','https://www.stihl.lu/enregistrement-de-produit.aspx')
   cy.wait(2000)
   cy.get('.start-link').eq(1).click({force:true})
     .should('have.attr','href','http://www.stihl.lu/mentions-legales-subpage.aspx')
 })
